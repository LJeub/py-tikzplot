...
\pgfplotscreateplotcyclelist{mymarks}{
    every mark/.append style={solid,fill=\pgfplotsmarklistfill, scale=1.1, fill opacity=1},mark=*\\
    every mark/.append style={solid,fill=\pgfplotsmarklistfill},mark=square*\\
    every mark/.append style={solid,fill=\pgfplotsmarklistfill, scale=1.5},mark=triangle*\\
    every mark/.append style={solid,fill=\pgfplotsmarklistfill, scale=1.5},mark=diamond*\\
    every mark/.append style={solid,fill=\pgfplotsmarklistfill, scale=1.5},mark=pentagon*\\
    every mark/.append style={solid, scale=2},mark=x\\
    every mark/.append style={solid, scale=2},mark=asterisk\\
}
...
\pgfplotsset{/tikz/mark size={1pt}}
